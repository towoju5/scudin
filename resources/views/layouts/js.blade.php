  ...
  <script type="text/javascript">
    ...
    var _img = "{{ asset('default.png') }}";
    var errImg = "this.onerror=null;this.src='" +_img +"';";
    // var errImg = "this.onerror=null;this.src='https://placeimg.com/200/300/animals';"
    $("img").attr('onerror', errImg);
  </script>